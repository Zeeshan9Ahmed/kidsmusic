...
<head>
 ...
 <style>
    ...
    .btn-primary {
        ...
        border-color: #040493 !important;
    }
    .btn-primary:hover, .btn-primary:focus, .btn-primary:active, .btn-primary.active {
        background-color: #030369 !important;
        border-color: #030369 !important;
    }
    .authentication-box {
        min-width: 100vw;
        min-height: 100vh;
    ...
    .react-tabs .nav-tabs .nav-link.react-tab-selected, .react-tabs .nav-tabs .nav-link:hover, .react-tabs .nav-tabs .nav-link:focus {
        ...
        border-bottom: 2px solid #040493 !important;
        color: #040493;
    }
    .login-btn {
                       ...
                       <div>
                          <div class="react-tabs" data-tabs="true">
                             ...
                             <div class="login-tab" role="tabpanel">
                                <form class="form-horizontal auth-form ajaxForm" action="" method="post">
                                    {{ csrf_field() }}
